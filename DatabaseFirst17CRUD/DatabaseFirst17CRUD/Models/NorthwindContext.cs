...
namespace DatabaseFirst17CRUD.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(@"Data Source=LOCKERMX-PC\MSSQLSERVERS;Initial Catalog=Northwind;Integrated Security=True;");
        }
